...
/**
 * Eagerly loads beans that are annotated with @Eager
 *
 * This makes use of CDI Extensions.  Must add a file
 * META-INF/services/javax.enterprise.inject.spi.Extension
 * which contains one line containing the fully qualified name of this class.
 */
